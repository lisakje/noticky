...
class SheetMusicEditor(QDialog):
    # class KeyboardListener(QThread):
        #note_added = pyqtSignal(str) #co to je # nvm ale breci kdyz to tam neni
        ...
        #def run(self):
        #        while True:
        #            for note in self.key_to_note:
        #                keyboard.wait(note)
                        # wait nebo tohle: if keyboard.is_pressed(note):
        #                self.add_note_to_file(self.key_to_note[note])
                        #asi?
